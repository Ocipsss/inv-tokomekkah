    ...
    <div className="p-2 pb-24 max-w-4xl mx-auto">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white p-3 rounded-xl border border-slate-100 shadow-sm space-y-3">
              <div>
                ...
                <input 
                  required type="text" placeholder="NAMA BARANG..."
              ...
              <div className="relative">
                ...
                <div className="relative mt-1">
                  ...
                  <input 
                    readOnly type="text" 
                    className="w-full p-3 pl-10 bg-slate-100 border-none rounded-xl text-xs font-mono font-bold text-blue-600 outline-none" 
                    value={formData.kode} 
                  />
                </div>
              </div>
            ...
            <div className="bg-white p-3 rounded-xl border border-slate-100 shadow-sm space-y-3">
              ...
              <div className="relative">
                ...
                <div className="relative mt-1">
                  ...
                  <input 
                    type="text"
                    placeholder={formData.lokasi || "CARI LOKASI RAK..."}
          ...
          {/* Section 3: Finansial & Stok - Berderet Kebawah */}
        <div className="space-y-2 md:col-span-2">
          ...
          <div className="bg-white p-3 rounded-xl border border-slate-100 shadow-sm space-y-3">
            ...
            {/* Input Harga Jual */}
            <div>
              <label className="text-[9px] font-bold text-slate-400 ml-1 uppercase text-emerald-600">Harga Jual Utama</label>
              <div className="relative mt-1">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] font-bold text-emerald-300">Rp</span>
                <input 
                  required type="text"
                  className="w-full p-3 pl-9 bg-slate-50 border-none rounded-xl text-xs font-black outline-none focus:ring-2 focus:ring-emerald-500 transition-all border-l-4 border-l-emerald-500"
                  placeholder="0"
        ...
        <button 
          disabled={loading}
          className="w-full bg-slate-900 text-white p-4 rounded-xl font-black text-xs uppercase tracking-[0.15em] shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2 disabled:bg-slate-300 mt-2"
        >
