...
export default function ProductsPage() {
      ...
      <div className="space-y-3">
        {filteredProducts.map((product) => (
          <div 
            ...
            className="bg-white p-4 rounded-[2rem] border border-slate-100 shadow-sm flex items-center gap-4 active:scale-[0.98] transition-all cursor-pointer"
          >
  ...
  <button 
    ...
    className="w-full bg-slate-900 text-white p-5 rounded-[1.8rem] font-black text-sm uppercase tracking-[0.2em] shadow-xl active:scale-95 transition-all flex items-center justify-center gap-3"
  >
  ...
  <button 
    onClick={() => setSelectedProduct(null)} // Hanya menutup modal karena ini sudah halaman detil
